...
# Datos de la tabla
tabla <- data.frame(
  Tipo = c("Principal", "Principal", "Principal", "Principal", "Principal", "Principal", "Sociodemográficas", "Sociodemográficas", "Sociodemográficas", "Sociodemográficas", "Laborales", "Laborales", "Laborales", "Laborales", "Laborales", "Laborales"), 
  Variable = c("Horas habituales de trabajo", "Tramo horas habituales de trabajo", "Tramo horas habituales de trabajo", "Tramo horas habituales de trabajo", "Tramo horas habituales de trabajo", "Tramo horas habituales de trabajo", "Sexo", "Edad", "Nivel educacional (CINE 2011)", "Grupo ocupacional (CIUO 08)", "Sector de actividad económica CAENES (adaptación de CIIU Rev. 4.cl)", "Tamaño de empresa (número de trabajadores)", "Categoría en la ocupación (CISE 93)", "Categoría en la ocupación (CISE 93)", "Categoría en la ocupación (CISE 93)", "Categoría en la ocupación (CISE 93)"), 
  Operacionalización = c("Total horas habituales de la ocupación principal/Total horas habituales de la ocupación principal y secundaria.", "1 a 30 horas", "31 a 39 horas", "40 horas", "41 a 44 horas", "45 horas", "Hombre = 1, Mujer = 2", "15 a 29 años", "Primaria o menos", "Directores y gerentes", "Ver Anexo 1", "Menos de 5 trabajadores", "Empleador", "Cuenta propia", "Asalariado sector privado", "Asalariado sector público"), 
...
g1 <- ggplot(data.frame(time = time(t_serie1), values = as.vector(t_serie1)), aes(x = time, y = values)) +
  geom_smooth(method = "lm", se = FALSE, color = colores[1], linetype = "longdash", linewidth = 0.7) +
  geom_line(linetype = "solid", color = colores[2], linewidth = 1) +
...
```{r echo=FALSE, fig.cap='Evolución distribución porcentual de trabajadores en tramos de 1 a 30 y 31 a 39 horas (2017-2023)'}
...
ggplot(data = df, mapping = aes(x = anotrim)) +
  geom_line(aes(y = v1, group = 1, color = "Color 1"), linewidth = 0.8) +
  geom_line(aes(y = v2, group = 1, color = "Color 2"), linewidth = 0.8) +
  scale_y_continuous(
    labels = function(prop){paste0(prop, "%")},
